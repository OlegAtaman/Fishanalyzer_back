...
# Функція для запису налаштувань у файл settings.txt
...
# Функція для зчитування файлу settings.txt
def read_settings():
    settings_data = {
        "rules_update": False,
        ...
        "sec_email": "",
    } # Ставимо значення за замочуванням

    if not os.path.exists(SETTINGS_FILE_PATH):
        return settings_data

    # Читаємо дані і записуємо оновлені значення
